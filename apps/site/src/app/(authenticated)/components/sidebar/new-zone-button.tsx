...
import { createManagementZone } from '@/app/(authenticated)/(accounts)/account/(with-shell)/management-zones/actions';
...
export default function NewZoneButton() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await createManagementZone(name.trim());
      if (result.error) {
