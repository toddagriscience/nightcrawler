...
import { db } from '../src/schema/connection';
import { integratedManagementPlan, knowledgeArticle } from '../src/schema';
...
const articles: SeedImp[] = [
  ...
  },
  {
    ...
    slug: 'post-harvest-handling-and-storage',
  ...
  },
  {
    ...
    slug: 'direct-to-consumer-market-strategies',
  ...
  },
  {
    ...
    slug: 'understanding-soil-salinity-and-ec',
  ...
  },
  {
    ...
    slug: 'cover-cropping-for-soil-health',
...
async function seed() {
  ...
  for (const article of articles) {
    ...
    await db.insert(integratedManagementPlan).values({
